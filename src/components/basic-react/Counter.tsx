      ...
      <Transitions>
        <div className="subDivStyle">
          ...
          <p className="m-25">
            ...
            long as it's greater than 0). The count state variable is used to
            keep track of the count, and the increment and decrement functions
          ...
          <div>
            ...
            <p className="m-25">
              ...
              "Increment" button is clicked. It increases the count by 1.
              <br></br>
              Decrement Function: The decrement function is called when the
              "Decrement" button is clicked. It decreases the count by 1, but
