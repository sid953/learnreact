      ...
      <Transitions>
        <div className="subDivStyle">
          ...
          <p className="m-25">
            ...
            the center of the page. The name 'siddhesh' is passed as a prop to
          ...
          <div>
            ...
            <p className="m-25">
              MyComponent: This is a functional component defined as
              MyComponent. It takes a single prop, name, which is of type
              string. Inside MyComponent, it returns JSX (JavaScript XML) to
              render a message with the provided name. h1 Element: Displays
              "Hello my name is [name]!" where [name] is the value passed as the
              name prop. p Element: Displays "I'm a frontend developer."{" "}
              <br></br>
              ...
              application. Inside App, it returns JSX that includes: A div
              element with the class "text-center." It renders the MyComponent
              by passing the name prop with the value 'siddhesh'.
            </p>
