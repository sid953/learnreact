  ...
  return (
    <div className="divStyle">
      ...
      <div className="subDivStyle">
        ...
        <p className="m-25">
          This code is a simple React application that demonstrates the concept
          of memoization using the useMemo hook.<br></br> Memoization is an
          ...
          provided again.<br></br> In this example, the expensive calculation is
        ...
        <div>
         <SyntaxHighlighter
          ...
          <p className="m-25">
            There are two components defined in this code: ExpensiveCalculation
            and App.<br></br>
            ...
            executed when props.value changes.<br></br>
            ...
            factorial of the new count is calculated and displayed.<br></br>
