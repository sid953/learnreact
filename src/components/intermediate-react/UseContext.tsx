        ...
        <div className="subDivStyle">
          ...
          <div>
            ...
            <p className="m-25">
              ...
              components.<br></br>
              count is a piece of state created using useState and initialized
              to 0. This represents the shared state value that we want to
              manage.
              <br></br>
              increment is a function that allows you to modify the count state
              when called.<br></br>
              Inside the return statement, the MyContext.Provider component
              wraps its child components, which are passed as children. The
              value prop is set to an object containing count and increment.
              This object represents the data that will be made available to
              descendant components.<br></br>
              <b>Step 3: Create Consumer Components</b>
              <br></br>
              Two consumer components, Counter and Display, are created to
              access and utilize the shared state and functions provided by the
              MyProvider component.
              <br></br>
              The App component wraps the entire application within the
              MyProvider component. By doing this, it makes the shared context
              and state available to its child components, Counter and Display,
              and any other components within its subtree.<br></br>
              The child components, Counter and Display, are rendered inside the
              App component and have access to the shared context data provided
              by MyProvider.<br></br>
            </p>
