      ...
      <Transitions>
        <div className="subDivStyle">
          ...
          <p className="m-25">
            ...
            wrapping it with another component. HOCs are not components
            themselves but functions that accept a component and return a new
            component with additional features, props, or behavior. They are a
            way to reuse and share component logic without repeating it across
            multiple components.
            <br></br>
            ...
            different components. For example, you can create a loading HOC to
            add loading indicators to multiple components without duplicating
            the loading logic.<br></br>
            <b>Separation of Concerns : </b>
            HOCs allow you to separate the concerns of a component, keeping it
            focused on its primary functionality. The additional logic or
            behavior is abstracted into the HOC.<br></br>
          ...
          <div>
            ...
            <p className="m-25">
              ...
              <br></br>n this step, a HOC named withLoading is defined. It
              accepts a WrappedComponent as an argument and returns a new
              component, WithLoadingComponent, that adds loading behavior. The
              loading behavior is simulated with a state variable (loading) and
              the useEffect hook, which sets loading to false after a delay of 2
              ...
              component without loading behavior, and it serves as an example of
              a component you might want to enhance with the HOC.
              <br></br>
              <b>Step 3: Apply the HOC to the Component:</b>
              <br></br>
              Here, the withLoading HOC is applied to MyComponent, creating a
              new component called MyComponentWithLoading.
              <br></br>
