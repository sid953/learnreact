        ...
        <div className="subDivStyle">
          ...
          <div>
            ...
            <p className="m-25">
              ...
              initialState defines the initial state of your application. In
              this case, it's a simple object with a count property set to 0.
              <br></br>
              rootReducer is a function that takes the current state and an
              action and returns the new state. It handles actions like
              'INCREMENT' and 'DECREMENT' by modifying the count property
              accordingly.<br></br>
              ...
              The useDispatch hook is used to get access to the dispatch
              function, which is used to dispatch actions to the store.<br></br>
              The increment and decrement functions are defined to dispatch
              'INCREMENT' and 'DECREMENT' actions when the respective buttons
              are clicked.<br></br>
              <b>Step 3: Integrate the Components with the Redux Store</b>
              <br></br>
              The Provider component from react-redux wraps the entire
              application and is used to provide access to the Redux store to
              all components in the component tree.<br></br>
