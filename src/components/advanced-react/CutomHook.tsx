    ...
    <div className="divStyle">
      ...
      <div className="subDivStyle">
        ...
        <p className="m-25">
          ...
          custom hook to manage counters with different initial values.<br></br>
        ...
        <div>
         <SyntaxHighlighter
          ...
          <p className="m-25">
            ...
            useState.<br></br>
            It provides increment and decrement functions that update the count
            state.<br></br>
            The hook returns an object with count, increment, and decrement for
            components to use.<br></br>
            <b>Step 2: Use the Custom Hook in Components</b>
            <br></br>
            Both CounterComponent and AnotherComponent use the useCounter custom
            hook to manage their own counters. They pass an initial value to the
            hook.<br></br>
